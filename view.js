...
function buttonSetup(type, typeUpper, label) { //lol javascript
    ...
    document.getElementById(type+'Cost').innerHTML = "成本: " + intToString(displaySquare[type+'CostAfterMultiBuy'](settings.buyPerClick))+", ";
    document.getElementById(type+'Benefit').innerHTML = "每个创建 +"+ intToString(displaySquare[type+'AmountBonus']*getNaniteGainBonus()) +", ";
    document.getElementById(type+'SpecialNext').innerHTML = "下一次奖励在 "+displaySquare[type+'NextSpecial']+"级。";
